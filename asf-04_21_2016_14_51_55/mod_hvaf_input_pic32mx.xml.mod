<Test Component="USART" Layer="DRIVER" Version="v0.2">
   ...
   <TestScenarios>
      ...
      <TestScenario name="USART Sample Test Scenario 2" value="1">
         <TestCase id="USART Driver Basic Read Test case 1" value="0" priority="High" type="Functional" severity="High" IsEnabled="true">
            <Description>DRV_USART_Read function reads given number of bytes from the USART PC Console/Tester.sdtsdgtwegwegwegwegwe</Description>
            <DataSets>
               <dataSet>
                  <className>DATACLASS_D</className>
                  <startIndex>3</startIndex>
         ...
         <TestCase id="USART Driver Basic Read Test case 2" value="1" priority="High" type="Functional" severity="High" IsEnabled="true">
            <Description>DRV_USART_Read function reads given number of bytes from the USART PC Console/Tester.sdfsdgfsdgwegwegweg</Description>
            <DataSets>
               <dataSet>
                  <className>DATACLASS_D</className>
                  <startIndex>2</startIndex>
         ...
         <TestCase id="USART Driver Basic Read Test case 3" value="2" priority="High" type="Functional" severity="High" IsEnabled="true">
            <Description>DRV_USART_Read function reads given number of bytes from the USART PC Console/Tester.werfwegfgweg</Description>
            <DataSets>
               <dataSet>
                  <className>DATACLASS_D</className>
                  <startIndex>1</startIndex>
